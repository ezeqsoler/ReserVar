...
public class ParkingLot2Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_parking_lot_2);

        // Set the title of the activity
        setTitle(R.string.parking_lot_2_button_label);

        // Set the counters for available spaces and capacity
        int availableSpaces = 30;
        int capacity = 100;
